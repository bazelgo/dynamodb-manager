...
require (
	github.com/bazelgo/dynamodb-manager/client v0.0.0-20240222085729-e3c1b60177b1
...
require (
	...
	github.com/bazelgo/dynamodb-manager/logging v0.0.0-20240222080558-382a7685411e // indirect
